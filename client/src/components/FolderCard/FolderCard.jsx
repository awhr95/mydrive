...
const FolderCard = ({ folder, isRenaming, isClicked, renameProps, onClick, onStartRename, onDelete }) => (
  <div
    className={`dashboard__card dashboard__card--folder${isClicked ? " dashboard__card--clicked" : ""}`}
